...
replace github.com/spf13/cast => github.com/spf13/cast v1.3.1

replace github.com/blevesearch/bleve/v2 => github.com/knights-analytics/bleve/v2 v2.0.0-20241018105832-b9b0e4da3ce2
